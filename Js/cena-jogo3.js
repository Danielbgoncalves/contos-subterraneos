...
export default class CenaJogo3 extends Phaser.Scene {
    ...
    create( data ){
       ...
       /* let config = {
        ...
        //peixes
        this.peixe1 = this.add.image(420,430,'peixe');
        this.peixe2 = this.add.image(410,440,'peixe');
        this.peixe3 = this.add.image(423,446,'peixe');
        this.peixe1.setVisible(false);
        this.peixe2.setVisible(false);
        this.peixe3.setVisible(false);
        ...
        if(this.coletarRespostaAouB){ // a = batalha e b = conversa
            if(/^[a-zA-Z]$/.test(key)){
                ...
                if(this.resposta.toLowerCase() === 'a'){
                    //this.music.stop();
                    this.scene.start('CenaLuta2', {personagem: 1, cenaOrigem: 'CenaJogo3'});
    ...
    update(){
        ...
        if(this.peixeAnims){
            ...
            //console.log("apareceram os peixes");
            this.peixe1.setVisible(true);
            this.peixe2.setVisible(true);
            this.peixe3.setVisible(true);
        ...
        if(this.coletaPeixe){
            if(jogador.y < 430 && jogador.y >400 && jogador.x > 410 && jogador.x < 423 ){
                cont = 25;
                this.peixeAnims = false;
                console.log("desapareceram os peixes");
                this.add.image(200, 400, 'coletado');
